...
// UBX-ACK-ACK
static const ubx_cfg_t ack_header[6] = { 0xB5, 0x62, 0x05, 0x01, 0x00, 0x02};

// UBX-ACK-NAK
static const ubx_cfg_t nak_header[6] = { 0xB5, 0x62, 0x05, 0x00, 0x00, 0x02};
...
static ubx_cfg_t mon_ver[8] = { 0xB5, 0x62, 0x0A, 0x04, 0x00, 0x00, 0x00, 0x00};
// // UBX-CFG-PM2
// // Load the configuration from memory
