 ...
 *  \ingroup hardware_sleep
 */
static inline void rec_sleep_run_from_xosc(void) {
    rec_sleep_run_from_dormant_source(DORMANT_SOURCE_XOSC);
}

/*! \brief Set the dormant clock source to be the ring oscillator
 *  \ingroup hardware_sleep
 */
static inline void rec_sleep_run_from_rosc(void) {
    rec_sleep_run_from_dormant_source(DORMANT_SOURCE_ROSC);
}
 ...
 */
void rec_sleep_goto_dormant_until_pin(uint gpio_pin, bool edge, bool high);
 ...
 * \param gpio_pin The pin to provide the wake up
 */
static inline void rec_sleep_goto_dormant_until_edge_high(uint gpio_pin) {
    rec_sleep_goto_dormant_until_pin(gpio_pin, true, true);
}
 ...
 * \param gpio_pin The pin to provide the wake up
 */
static inline void rec_sleep_goto_dormant_until_level_high(uint gpio_pin) {
    rec_sleep_goto_dormant_until_pin(gpio_pin, false, true);
}
