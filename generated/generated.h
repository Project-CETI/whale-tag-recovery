...
static const aprs_config_s aprs_config = {"J75Y", 1, "/C", "APRS", "WIDE2", 2, "Hi Phil", false, 300000, 30000, 144.39};
static const timing_config_s timing_ = {7, 19, 30000, 30000, false};
